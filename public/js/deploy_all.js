var Page = {
        ...
        return $('.js-exportable').DataTable({
            ...
            ajax: function (data, callback, settings) {
                ...
                function getFormJson(idF, idS, idI) {
                    ...
                    searchData.is_deployed = '' //不設定上版狀態
                    //取得form表單資訊
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        // console.log(row)
                        return (row.deploy_status == 0)? 
                        '<span class="badge badge-danger">待上版</span><br><input type="button" class="btn btn-primary btn-sm mt-1" value="上版" onclick="single_deploy('+row.sys_id+')">'
                        : '<span class="badge badge-success">已上版</span><br><input type="button" class="btn btn-warning btn-sm mt-1" value="退版" onclick="single_cancel('+row.sys_id+')">'
                    },
                }
            ],
    ...
    handleEvents: function handleEvents() {
        ...
        // 上版公告查詢
        $('#date_query').on('click', function (e) {
